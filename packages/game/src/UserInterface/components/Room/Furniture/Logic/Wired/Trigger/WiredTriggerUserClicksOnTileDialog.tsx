...
export type WiredTriggerUserClicksOnTileDialog = {
    furniture: RoomInstanceFurniture<WiredFurnitureSelectionData>;
    type: "wf_trg_says_something";
};

export default function WiredTriggerUserClicksOnTileDialog({ data, onClose }: RoomFurnitureLogicDialogProps<WiredTriggerUserClicksOnTileDialog>) {
    ...
    return (
        <WiredDialog onClose={onClose}>
            ...
            <WiredFurniturePicker value={furnitureIds} onChange={setFurnitureIds} maxFurniture={20} restrictedToFurnitureTypes={["room_invisible_click_tile"]}/>
